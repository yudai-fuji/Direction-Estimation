# --- PCA法 / 角速度累積法 / 角速度PCA法を
#     RMSE比較＋時系列比較＋指定区間の左右平均絶対誤差統計＋
#     PCA寄与率プロット（左右別描き）する完成版 ---
...
is_mask_g = 0          # 角速度累積法プロット表示 1:-180~180° 1以外:指定なし
...
print("=== PCA法 ===")
print(f"右手のRMSE:      {RMS_R_pca:.4f} [deg]")
print(f"左手のRMSE:      {RMS_L_pca:.4f} [deg]")
print(f"左右平均のRMSE:  {RMS_mean_pca:.4f} [deg]")


# =========================================================
# 2) 角速度累積法の heading と RMSE
# =========================================================
...
print("\n=== 角速度累積法 ===")
print(f"右手のRMSE:      {RMS_R_gyro:.4f} [deg]")
print(f"左手のRMSE:      {RMS_L_gyro:.4f} [deg]")
print(f"左右平均のRMSE:  {RMS_mean_gyro:.4f} [deg]")


# =========================================================
# 3) 角速度PCA法の heading と RMSE
# =========================================================
...
RMS_R_gyro_pca, RMS_L_gyro_pca, RMS_mean_gyro_pca = calc_rms_from_headings(
    heading_R_gyro_pca,
    heading_L_gyro_pca
)

print("\n=== 角速度PCA法（第二主成分） ===")
print(f"右手のRMSE:      {RMS_R_gyro_pca:.4f} [deg]")
print(f"左手のRMSE:      {RMS_L_gyro_pca:.4f} [deg]")
print(f"左右平均のRMSE:  {RMS_mean_gyro_pca:.4f} [deg]")


# =========================================================
# 4) 時系列プロット（PCA法 / 角速度累積法 / 角速度PCA法）
# =========================================================
...
plot_heading_timeseries(
    heading_R_gyro_pca, heading_L_gyro_pca,
